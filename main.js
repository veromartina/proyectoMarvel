...
function crearTarjetas(tarjetas, tipo) {
  tarjetas.forEach((tarj) => {
    ...
    conteImg.className = "contenedorImg"; // clase compartida por ambas tarjetas
    nuevaTarjeta.appendChild(conteImg);

    const divH3 = document.createElement("div");
    nuevaTarjeta.appendChild(divH3);

    const titulo = document.createElement("h3");
    divH3.appendChild(titulo);
    ...
    if (tipo === "comics") {
      ...
      conteImg.className = "contenedorimgPersonajes";
...
const deshabilitarOHabilitarBotones = (
  offset = 0,
  ...
  if (paginaActual === 0) {
    ...
    primeraPagina.classList.remove(
      "bg-gray-500",
      "bg-opacity-30",
      "boton-desabilitado"
    );
    ...
    paginaAnterior.classList.remove(
      "bg-gray-500",
      "bg-opacity-30",
      "boton-desabilitado"
    );
  ...
  if (offset + resultadosPorPagina >= cantidadDeResultados) {
    ...
    paginaSiguiente.classList.remove(
      "bg-gray-500",
      "bg-opacity-30",
      "boton-desabilitado"
    );
